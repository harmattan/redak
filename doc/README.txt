...
|author= [[User:www.rzr.online.fr]]
  ...
  Package: redak
  URL: http://www.developer.nokia.com/Community/Wiki/Redak
...
First I created for harmattan then ported to symbian, 
the main issue was a minor bug in C++ that prevent loading files (bad path workaround) 
I feared that was a security issue but it's not ...

Most of the qml code is common between meego and symbian
but I did not shared common parts and I prefer to merge new features ...
